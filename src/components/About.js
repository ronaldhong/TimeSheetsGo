  ...
  render(){
    ...
    return(
      <div className="about_box">
        ...
        <div>
          <div  className="about_div_box about_flex">
            <h4 style={h4_style}>
              <FontAwesome id="user" className='super-crazy-colors' name='user' size='2x' style={{ textShadow: '0 1px 0 rgba(0, 0, 0, 0.1)', 'background-color':"#D0D0D0",color:'white', padding:"7px", "border-radius":"100%",height: "50px",width:'50px','text-align':'center' }}/>
            </h4>
            <div>
                <h3>DESIGN WITH PASSION</h3>
          ...
          <div className="about_div_box about_flex">
            <h4 style={h4_style}>
              <FontAwesome id="star" className='super-crazy-colors' name='star' size='2x' style={{ textShadow: '0 1px 0 rgba(0, 0, 0, 0.1)', 'background-color':"#D0D0D0",color:'white', padding:"7px", "border-radius":"100%",height: "50px",width:'50px','text-align':'center' }}/>
            </h4>
            <div>
              <h3>CLEAR VISION</h3>
